...
<nav style="text-align: center;">
	<img src="images/coykillericon-50-38.png"/>OWASP Mutillidae II: Keep Calm and Pwn On
</nav>
<nav class="navMenu" colspan="3" style="background:#272727;margin-top: 30px;padding-bottom: 10px;padding-top: 15px;">	
	...
	|
	<a href="index.php?page=captured-data.php">Captured Data</a>
	<div class="dot"></div>
</nav>
