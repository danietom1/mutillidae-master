...
<div class="card" style="text-align:center; margin:0 auto; max-width: 1000px; height: 50px;">
	<h2 style="text-align:center; margin:0 auto;">Please choose your username, password and signature</h2>
</div>
		...
		<table>
			...
			<tr>
				...
				<td colspan="2"  style="text-align:center; margin:0 auto;">
					<input type="text" name="username" size="15" autofocus="autofocus" class="input" placeholder="Username"
						<?php
			...
			<tr>
				...
				<td  style="text-align:center; margin:0 auto;">
					<input type="password" name="password" size="15" class="input" placeholder="Password"
						<?php
							if ($lEnableHTMLControls) {
								echo('minlength="1" maxlength="15" required="required"');
							}// end if
			...
			<tr>
				...
				<td colspan="2"  style="text-align:center; margin:0 auto;">
					<input type="password" name="confirm_password" size="15" class="input" placeholder="Confirm Password"
						<?php
							if ($lEnableHTMLControls) {
								echo('minlength="1" maxlength="15" required="required"');
							}// end if
			...
			<tr>
				...
				<td colspan="2"  style="text-align:center; margin:0 auto;">
					<textarea rows="3" cols="50" name="my_signature" class="input" placeholder="Signature" style="width: 1000px; height: 3000px;"
						<?php
							if ($lEnableHTMLControls) {
			...
			<tr>
				<td colspan="2" style="text-align:center;">
					<button name="register-php-submit-button" class="button" type="submit" value="Create Account">Register</button>
				</td>
			</tr>
			<tr><td>&nbsp;</td></tr>
		</table>
