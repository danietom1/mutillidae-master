	...
	<form 	action="index.php?page=login.php"
		...
		<table>
			<tr id="id-authentication-failed-tr" style="display: none;">
				<td id="id-authentication-failed-td" class="error-message"></td>
			</tr>
			<tr><td></td></tr>
			<tr>
				<td style="text-align:center; margin:0 auto;">
					<div class="card" style="text-align:center; margin:0 auto;">
						<h2 style="text-align:center; margin:0 auto;">Please Login</h2>
					</div>
				</td>
			</tr>
			<tr><td></td></tr>
			<tr>		
				...
				<td >
					<input	type="text" name="username" size="20" class="input" placeholder="Username"
							autofocus="autofocus"
					<?php
			...
			<tr>
				<td  style="text-align:center;">
					<button name="login-php-submit-button" class="button" type="submit" value="Login">Login</button>
